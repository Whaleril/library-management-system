...
const ReaderDashboard = ({ user, stats, books, currentPage, setCurrentPage }) => {
    ...
    <div className="content">
      ...
      <div className="table-section">
        <table className="data-table">
          ...
          <tbody>
            <tr>
              <td colSpan="5" className="no-data">No loan records</td>
            </tr>
          </tbody>
        </table>
      </div>
    ...
    <div className="content">
      ...
      <div className="table-section">
        <table className="data-table">
          ...
          <tbody>
            <tr>
              <td colSpan="4" className="no-data">No hold records</td>
            </tr>
          </tbody>
        </table>
      </div>
